...
import com.women_period_cycle.women_period_cycle_files.activity.MainActivity;
...
public class EvaSchedulingService extends IntentService {
    ...
    private void sendNotification(String title, String msg) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String NOTIFICATION_CHANNEL_ID = "com.women_period_cycle.women_period_cycle_files";
